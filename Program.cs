    ...
    class Program
    {
        ...
        static void Yakuhantei()
        {
           ...
           　
            ...
            // スリーカード
            else if (numberCount[0]==4)
            {
                Console.WriteLine("フォーカード");
            }

            else if ((numberCount[0] == 3 && numberCount[1]==2 )||(numberCount[0]==2 && numberCount[1]==3))
            {
                Console.WriteLine("フルハウス");
            }
            else if (numberCount[0] == 3)
            {
                Console.WriteLine("スリーカード");
            }

            else if (numberCount[0] == 2 && numberCount[1] ==2)
            {
                Console.WriteLine("ツーペア");
            }

            else if (numberCount[0] == 2)
            {
